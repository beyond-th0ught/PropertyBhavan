...
const edit = (
  <svg
    className="fill-deep_purple_700 cursor-pointer"
...
export default function MyAccount() {
  ...
  return (
    <>
    <Layout>
      <div className="myaccount_container profile_container flex gap-7 flex-col items-center mt-12 ">
        <div className="flex md:w-96 w-72 myaccount_name_container gap-3">
        ...
        <div className=" md:w-96 w-72 items-center flex border rounded-lg pr-3 border-deep_purple_700 ">
        ...
        <div className=" md:w-96 w-72 items-center flex border rounded-lg pr-3 border-deep_purple_700">
          <div className="text-black w-36 vsm:w-96 px-5 py-2 account_input flex-1   rounded-lg ">
            {state.profileData?.mobileNum}{" "}
            
          </div>
          {edit}
        </div>
        <button className="md:w-80 w-56 text-lg py-1.5 rounded-lg text-white mx-auto bg-deep_purple_700 hover:bg-deep_purple_500 border-2">
          Save Change
        </button>
      </div>
      </Layout>
