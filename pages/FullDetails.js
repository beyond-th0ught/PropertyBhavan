import "../styles/ListView.module.css";
...
const PropertyCard = dynamic(() => import('../components/FullDetailsComponents/Middle/PropertyCard'), {
  ssr: false,
})
      ...
      <div className="fulldetails">
        {!loading ? <>
          ...
          <div className="contact_container">
            <p className="location">{fullDetails?.address}</p>
          </div>
          ...
          <h2 className="heading">Similar Properties</h2>

          <PropertyCard />
          <div className="contact_right property_price_contact">
            
            <button onClick={handleContact} className="contact">{contactNow}</button>
          </div>
          <MembershipModal type='buyer' amount={299} openMemberModal={openMemberModal} setOpenMemberModal={setOpenMemberModal}/>
          <div className="fulldetail_footer">
            <FooterHero />
            <Footer />
          </div> </> : <Loading />}
      </div>
