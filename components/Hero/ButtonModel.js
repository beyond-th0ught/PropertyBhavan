...
function ButtonModel() {
  return (
    <div>
            ...
            <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
                <div className="flex items-center justify-center ">
                  <img
                    className="object-cover w-12 h-12 rounded-full ring ring-white"
                  ...
                  />
                  <img
                    className="object-cover w-12 h-12 -mx-4 rounded-full ring ring-white"
              ...
              <div className="mt-4">
                ...
                <div className="flex items-center mt-2 -mx-1">
                  <input
                    type="text"
                    defaultValue="https://merakiui.com/project/"
      ...
      Multi Invites RTL Show Code Sign up for our newsletter Subscribe to our
      newsletter to notify when we publish new components Email address Enter
      your email Notify me Twitter GitHub © 2022 Meraki UI. All rights reserved.
    </div>
  );
}
