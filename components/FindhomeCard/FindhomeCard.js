...
var FindhomeCard = React.createClass({
    render: function() {
      return (
        ...
        <div className="max-w-2xl px-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
          ...
          <div className="mt-2">
            <a href="#" accessKey="5" className="text-2xl font-bold text-gray-700 dark:text-white hover:text-gray-600 dark:hover:text-gray-200 hover:underline">Accessibility tools for designers and developers</a>
          ...
          <div className="flex items-center justify-between mt-4">
            <a href="#" accessKey="6" className="text-blue-600 dark:text-blue-400 hover:underline">Read more</a>
