...
import SimilarBox from "./FullDetailsComponents/Bottom/SimilarBox";
...
const FooterHero = dynamic(() => import('./FooterHero/FooterHero'), {
  ssr: false,
})
...
const ListView = () => {
  ...
  // useTitle(`Properties in ${parms?.address}`,`found ${listItemshow?.length} properties in ${parms?.address} for ${parms?.type}`)
